 ...
 * Alteratively, you can set `PREZLY_ANALYTICS_FORCE_PROD_API` to `true` in your .env to use the production analytics URL.
 */
export function getApiUrl(): string {
    if (
        process.env.NODE_ENV !== 'production' &&
        process.env.PREZLY_ANALYTICS_FORCE_PROD_API !== 'true'
    ) {
